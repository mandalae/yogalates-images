...
resource "aws_lambda_permission" "Yogalates-images" {
  ...
  source_arn = "arn:aws:execute-api:eu-west-1:368263227121:${aws_api_gateway_rest_api.Yogalates.id}/*/${aws_api_gateway_method.GET_images.http_method}${aws_api_gateway_resource.Yogalates-images.path}"
}
