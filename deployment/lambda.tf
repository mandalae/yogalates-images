...
resource "aws_lambda_permission" "Yogalates-images" {
  ...
  source_arn = "arn:aws:execute-api:eu-west-1:368263227121:${var.rest_api_id}/*/${aws_api_gateway_method.GET_images.http_method}${aws_api_gateway_resource.Yogalates-images.path}"
}
